...
var CentipedeSeg = require('./Centipede-Segment.js');
var CentipedeWho = require('./Centipede-Whole.js');
...
var arrayOfBullets = [];
var centipede = new CentipedeWho;
...
document.body.addEventListener('keydown', function(event) {
  ...
  if (event.keyCode === 32) {
    arrayOfBullets.push(new Bullet(playerInitialize.x+12,playerInitialize.y));
